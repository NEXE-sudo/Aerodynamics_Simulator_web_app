...
import { StreamlineGenerator } from "../lib/simulation/StreamlineGenerator";
...
export default function ThreeJSViewer(props: ThreeJSViewerProps) {
  ...
  const streamlines = useMemo(() => {
    ...
    return generator.generateStreamlines(20);
  }, [props.velocity, props.angleOfAttack]);
    ...
    <div className="w-full h-full relative bg-slate-950 rounded-xl border border-slate-800">
      <Canvas shadows>
        ...
        <Suspense fallback={null}>
          <ModelRenderer geometry={props.geometry} />
          <FlowRenderer
